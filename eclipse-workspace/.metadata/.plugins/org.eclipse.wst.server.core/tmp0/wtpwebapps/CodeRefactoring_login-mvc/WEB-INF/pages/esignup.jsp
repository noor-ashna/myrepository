  ...
  <div class="container">
  	...
  	<div class="form-group">
  	   ...
  	   <select name="role" class="form-control" style="width: 40%;">
  	       <option ${signup.role=='Admin'?'selected':''}>Admin</option>
  	       <option  ${signup.role=='Customer'?'selected':''}>Customer</option>
  	       <option ${signup.role=='Employee'?'selected':''}>Employee</option>
  	   </select>  	
  	...
  	<div class="form-group">
  	   ...
  	   <select name="gender" class="form-control" style="width: 40%;">
  	       <option ${signup.role=='Male'?'selected':''}>Male</option>
  	       <option  ${signup.role=='Female'?'selected':''}>Female</option>
  	       <option ${signup.role=='Other'?'selected':''}>Other</option>
  	   </select>  	
  	</div>
