...
<button type="button" class="btn btn-primary">Sign In</button>
  ...
  <table class="table table-dark table-hover">
    ...
    <wow:forEach var="item" items="${pkpksignUps}">
      <tr>
        <td>${item.username}
          <a href="addDog?pid=${item.sid}">
         	<button type="button" class="btn btn-primary">Add Dog</button>
          </a>
          
           <a href="showDogs?pid=${item.sid}">
         	<button type="button" class="btn btn-danger">Show Dogs</button>
          </a>
           <a href="updateDogs?pid=${item.sid}">
         	<button type="button" class="btn btn-secondary">Update Dogs</button>
          </a>
        </td>
        <td>${item.password}</td>
        <td>${item.email}</td>
       ...
       <td>${item.role}</td>
       <td>
          <a href="changePassword?sid=${item.sid}">
